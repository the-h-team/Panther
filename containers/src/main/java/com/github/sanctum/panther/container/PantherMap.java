 ...
 */
public interface PantherMap<K, V> extends Iterable<PantherEntry.Modifiable<K, V>> {
	 ...
	 */
	default PantherCollection<PantherEntry.Modifiable<K, V>> entries() {
		PantherCollectionBase<PantherEntry.Modifiable<K, V>> keys = new PantherSet<>();
		forEach(keys::add);
		return keys;
	}
	 ...
	 */
	default PantherCollection<K> keys() {
		PantherSet<K> keys = new PantherSet<>();
	 ...
	 */
	default PantherCollection<V> values() {
		PantherList<V> keys = new PantherList<>();
	 ...
	 */
	default Stream<PantherEntry.Modifiable<K, V>> stream() {
